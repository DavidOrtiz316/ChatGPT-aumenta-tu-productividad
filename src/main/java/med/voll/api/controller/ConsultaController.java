...
public class ConsultaController {
    ...
    public ResponseEntity<List<DatosRelatoriosConsultaMensual>> generarRelatorioConsultaMensual(@PathVariable String mes) {
        try {
            YearMonth yearMonth = YearMonth.parse(mes);
            int year = yearMonth.getYear();
            int month = yearMonth.getMonthValue();

            List<DatosRelatoriosConsultaMensual> reporte = consultaRepository.buscarConsultasPorMes(year, month);
